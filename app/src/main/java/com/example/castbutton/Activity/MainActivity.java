package com.example.castbutton.Activity;
...
import com.example.castbutton.Utils.CustomVolleyRequest;
import com.example.castbutton.Utils.MediaItem;
import com.example.castbutton.Utils.Utils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMedia = new MediaItem("https://commondatastorage.googleapis.com/gtv-videos-bucket/CastVideos/mp4/DesigningForGoogleCast.mp4", "https://commondatastorage.googleapis.com/gtv-videos-bucket/CastVideos/images/480x270/DesigningForGoogleCast2-480x270.jpg");
        mSelectedMedia.setTitle("CastButtonTest1");
        mSelectedMedia.setStudio("CastButtonTest2");
        ...
        //캐스트버튼
        androidx.mediarouter.app.MediaRouteButton mrb = findViewById(R.id.media_route_button);
...
//                Utils.showErrorDialog(LocalPlayerActivity.this, msg);
    ...
    private void loadViews() {
        ...
        ViewCompat.setTransitionName(mCoverArt, "transition-image");
